...
function playFlash(flashid){
 ...
 for(var i=0;i<fpic.length;i++){
  ...
  var pics="", links="", texts="";
	...
	flash = flash + '<embed wmode="transparent" src="../feature_files/' + flashUrl + '" FlashVars="mylinkpic='+pics+'" width="'+ pic_width +'" height="' + pic_height +'" allowScriptAccess="sameDomain" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />';
	flash = flash + '</object>';
