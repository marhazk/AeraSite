...
function register($username,$password,$email)
{
        ...
        $query="insert into accounts(Id,Username,Password,Email,AccessLevel,Membership,LastOnlineUtc,Coins)";
...
function activate_user($user_id){
        $query="update accounts set Membership=2001 where Id=".$user_id;
        $results=mysql_query($query) or die(mysql_error());    
        if(!$results)
		{
...
if((isset($_POST['Submit']) && $_POST['Submit']=="Register"))
{
        ...
        $sql="select Username,Email from accounts where Username='".$_POST['username']."' or Email='".$_POST['email']."'";
