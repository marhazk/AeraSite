...
switch( roleid )
{
	case 16:	rolename = "ÎäÏÀ-ÄÐ";	break;
	case 17:		rolename = "÷ÈÁé-Å®";	break;
	case 18:		rolename = "½£Áé-ÄÐ";	break;
	case 19:		rolename = "·¨Ê¦-Å®";	break;
	case 20:    rolename = "Î×Ê¦-ÄÐ";	break;
	case 21:    rolename = "Î×Ê¦-Å®";	break;
	case 22:    rolename = "÷ÈÁé-ÄÐ";	break;
	case 23:    rolename = "Ñý¾«-Å®";	break;
	case 24:    rolename = "ÑýÊÞ-ÄÐ";	break;
	case 25:    rolename = "·¨Ê¦-ÄÐ";	break;
	case 26:    rolename = "÷ÈÁé-ÄÐ";	break;
	case 27:    rolename = "´Ì¿Í-Å®";	break;
	case 28:    rolename = "ÓðÃ¢-ÄÐ";	break;
	case 29:    rolename = "ÓðÃ¢-Å®";	break;
	case 30:    rolename = "ÓðÁé-ÄÐ";	break;
	case 31:    rolename = "ÓðÁé-Å®";	break;
	default:	rolename = "ÆÕÍ¨½ÇÉ«";
}
%>
...
<table width="80%" height="300" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td height="20" colspan="2"><%= LocaleUtil.getMessage(request,"role_modrol_AttackLevel") %>&nbsp;<input type="text" name="resistance3" value="<%=role.ep.resistance[3]%>" size="12" maxlength="10"/></td>
  </tr>
  <tr>
