<?php
	...
	$DB[itemlist]->connect("itemlist", "SELECT * FROM itemlist, uwebitems WHERE itemlist.iid=uwebitems.iid GROUP BY itemlist.iid HAVING ( COUNT(uwebitems.iid) > 0 ) ORDER BY itemlist.iname ASC");
