// JavaScript Document// ProPhoto3 build #773
...
function p3_embed_flash_galleries() {
	...
	jQuery('.p3-flash-gallery').each(function(){
		...
		var flashvars  = {
			globalSettings: 'http://edwintcg.com/blog/wp-content/uploads/p3/static/gallery.txt?65145',
			localSettings: 'http://edwintcg.com/blog/wp-content/uploads/p3/gallery/'+id+'_settings.txt?'+modtime,
		...
		swfobject.embedSWF(
			'http://edwintcg.com/blog/wp-content/themes/prophoto3/flash/gallery.swf?build=773', 
			'p3-flash-gallery-'+id, 
			parseInt(gal_width), 
			parseInt(gal_height), 
			'9', 
			'http://edwintcg.com/blog/wp-content/themes/prophoto3/flash/expressinstall.swf', 
			flashvars,
...
function p3_widgets() {
	...
	function p3_nav_menu_opacity() {	
		if (!jQuery.browser.msie) {	
			jQuery('#topnav li ul').css('opacity', 0.83);
		}
	}
	...
	function p3_handle_contact_form() {
		...
		if ( hash === 'error' ) {
			jQuery("#p3-contact-error")
				...
				.fadeTo(500, 0)
				.slideUp(300)
				.html('<p>Error submitting form, please try again and ensure all fields are inserted</p>');
		}
		if ( hash === 'success' ) {
			jQuery("#p3-contact-success")
				...
				.fadeTo(500, 0)
				.slideUp(300)
				.html('<p>Form submitted successfully, we shall revert ASAP and pls check your junk mail folder if you do not received our reply after 48hours.</p>');
		}
		...
		function p3_toggle_contactform(delay) {
			...
			jQuery('#contact-form').load('http://edwintcg.com/blog/wp-content/themes/prophoto3/includes/contact-form.php?ajax=1', function(){
...
function p3_stop_throb() {
	...
	function p3_comment_form_ajax_submit(c) {
		...
		jQuery.ajax({
			...
			error: function(XMLHttpRequest, textStatus, errorThrown){
				...
				// try to log error
				jQuery.post( 'http://edwintcg.com/blog/', { 
	...
	var flashheader_params = {
		FlashVars: "path2xml=http://edwintcg.com/blog/wp-content/uploads/p3/static/images.xml?65145",
		bgcolor: "#fdfdfc",
		wmode: "opaque"
	}
	swfobject.embedSWF(
		"http://edwintcg.com/blog/wp-content/themes/prophoto3/flash/flashheader.swf", 
		"masthead-image-do-flash", 
		"960", 
		"337", 
		"7.0.0", "http://edwintcg.com/blog/wp-content/themes/prophoto3/flash/expressinstall.swf", 
...
var p3_lightbox_info = {
	img_loading      : 'http://edwintcg.com/blog/wp-content/themes/prophoto3/images/lightbox-ico-loading.gif',
	img_btn_prev     : 'http://edwintcg.com/blog/wp-content/themes/prophoto3/images/lightbox-btn-prev.gif',
	img_btn_next     : 'http://edwintcg.com/blog/wp-content/themes/prophoto3/images/lightbox-btn-next.gif',
	img_btn_close    : 'http://edwintcg.com/blog/wp-content/themes/prophoto3/images/lightbox-btn-close.gif',
	img_blank        : 'http://edwintcg.com/blog/wp-content/themes/prophoto3/images/lightbox-blank.gif',
	img_fadespeed    : 400,
	border_width     : '10',
	resize_speed     : 400,
